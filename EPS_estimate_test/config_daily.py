...
EPS_EST_DIR = os.path.join(BASE_DIR, 'History_EPS_estimate')
...
EPS_EST_FILES = [
    os.path.join(EPS_EST_DIR, 'lseg_EPSestimate_data_20170618_to_20150101.csv'),
    os.path.join(EPS_EST_DIR, 'lseg_EPSestimate_data_20181203_to_20170619.csv'),
    os.path.join(EPS_EST_DIR, 'lseg_EPSestimate_data_20200518_to_20181204.csv'),
    os.path.join(EPS_EST_DIR, 'lseg_EPSestimate_data_20211031_to_20200519.csv'),
    os.path.join(EPS_EST_DIR, 'lseg_EPSestimate_data_20230418_to_20211101.csv'),
    os.path.join(EPS_EST_DIR, 'lseg_EPSestimate_data_20240930_to_20230419.csv'),
    os.path.join(EPS_EST_DIR, 'lseg_EPSestimate_data_20260319_to_20241001.csv')
]
...
EU_EPS_EST_DIR = os.path.join(EU_BASE_DIR, 'History_EPS_estimate')
...
EU_EPS_EST_FILES = [
    os.path.join(EU_EPS_EST_DIR, 'stoxx_EPSestimate_data_20160320_to_20150101.csv'),
    os.path.join(EU_EPS_EST_DIR, 'stoxx_EPSestimate_data_20180320_to_20160320.csv'),
    os.path.join(EU_EPS_EST_DIR, 'stoxx_EPSestimate_data_20200320_to_20180320.csv'),
    os.path.join(EU_EPS_EST_DIR, 'stoxx_EPSestimate_data_20220320_to_20200320.csv'),
    os.path.join(EU_EPS_EST_DIR, 'stoxx_EPSestimate_data_20240320_to_20220320.csv'),
    os.path.join(EU_EPS_EST_DIR, 'stoxx_EPSestimate_data_20260319_to_20240320.csv')
]
