...
class DataProcessor:
    ...
    def load_and_pivot(self, file_paths):
        ...
        # Sort values to ensure chronological order for pct_change
    ...
    def impute_missing(self, price_close, tot_ret):
        ...
        tot_ret_imputed = price_ret_imputed.fillna(0)
...
file_paths=[
    path/'hist_data'/'lseg_historyprice_data_20210930_to_20200420_ADVfiltered.csv',
    path/'hist_data'/'lseg_historyprice_data_20200420_to_20181102_ADVfiltered.csv',
    path/'hist_data'/'lseg_historyprice_data_20200420_to_20181102_ADVfiltered.csv',
    path/'hist_data'/'lseg_historyprice_data_20240828_to_20230320_ADVfiltered.csv',
    path/'hist_data'/'lseg_historyprice_data_20260214_to_20240829.csv'
]
data_processor = DataProcessor(benchmark_ticker='SPX')
data_processor.load_and_pivot(file_paths)